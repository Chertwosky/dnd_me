...
export function GameRoomPage({ roomId }: { roomId: string }) {
  ...
  const handleDragStartMasterPanel = useCallback(
    (event: ReactDragEvent<HTMLElement>, panelId: MasterPanelId) => {
  ...
  const handleDropMasterPanel = useCallback(
    (event: ReactDragEvent<HTMLElement>, targetId: MasterPanelId) => {
          ...
          >
                ...
                {gmPanelOrder
                  ...
                  .map((panelId) => (
                    <div
                      ...
                      draggable
                      onDragStart={(event) =>
                        handleDragStartMasterPanel(event, panelId)
                      }
                      onDragOver={(event) => {
                        event.preventDefault();
                        event.dataTransfer.dropEffect = "move";
                      }}
                      onDrop={(event) => handleDropMasterPanel(event, panelId)}
            ...
            >
              <div
                draggable={role === "gm"}
                onDragStart={(event) =>
                  role === "gm" && handleDragStartMasterPanel(event, "party")
                }
                onDragOver={(event) => {
                  if (role !== "gm") return;
                  event.preventDefault();
                ...
                onDrop={(event) =>
                  role === "gm" && handleDropMasterPanel(event, "party")
                }
                onDragEnd={() => setDraggedMasterPanel(null)}
                style={
                  role === "gm"
              ...
              <div
                ...
                onDragStart={(event) =>
                  role === "gm" &&
                  handleDragStartMasterPanel(event, "initiative")
                }
                onDragOver={(event) => {
                  if (role !== "gm") return;
                  event.preventDefault();
                ...
                onDrop={(event) =>
                  role === "gm" && handleDropMasterPanel(event, "initiative")
                }
                onDragEnd={() => setDraggedMasterPanel(null)}
                style={
                  role === "gm"
              ...
              {role === "gm" ? (
                <div
                  draggable
                  onDragStart={(event) =>
                    handleDragStartMasterPanel(event, "tools")
                  }
                  onDragOver={(event) => {
                    event.preventDefault();
                    event.dataTransfer.dropEffect = "move";
                  }}
                  onDrop={(event) => handleDropMasterPanel(event, "tools")}
                  onDragEnd={() => setDraggedMasterPanel(null)}
