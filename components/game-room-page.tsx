          ...
          <div className={`grid gap-4 ${role === 'gm' ? 'xl:grid-cols-[minmax(0,440px)_minmax(0,1fr)]' : 'xl:grid-cols-1'}`}>
            {role === 'gm' ? (
              <div className="min-w-0 space-y-4">
                {gmPanelOrder.map((panelId, index) => (
                  ...
                  >
                    <div
                      onMouseDown={(event) => handleStartMasterPanelDrag(panelId, 'left', event)}
            ...
            <div className="min-w-0 flex flex-col gap-4 xl:col-span-1">
              ...
              >
                {role === 'gm' ? (
                  <div
                    onMouseDown={(event) => handleStartMasterPanelDrag('party', 'right', event)}
                    className="flex cursor-grab flex-wrap items-center gap-2 rounded-2xl border border-white/8 bg-slate-950/40 px-3 py-2 text-xs text-slate-300 active:cursor-grabbing"
                  >
              ...
              >
                {role === 'gm' ? (
                  <div
                    onMouseDown={(event) => handleStartMasterPanelDrag('initiative', 'right', event)}
                    className="flex cursor-grab flex-wrap items-center gap-2 rounded-2xl border border-white/8 bg-slate-950/40 px-3 py-2 text-xs text-slate-300 active:cursor-grabbing"
                  >
                ...
                >
                  <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_320px]">
                    <div style={{ width: `min(100%, ${gmPanelWidths.tools}px)` }} className="space-y-2">
                      <div
                        onMouseDown={(event) => handleStartMasterPanelDrag('tools', 'right', event)}
                        className="flex cursor-grab flex-wrap items-center gap-2 rounded-2xl border border-white/8 bg-slate-950/40 px-3 py-2 text-xs text-slate-300 active:cursor-grabbing"
                      >
